...
import { LuxuryImagePlaceholder } from "../common/LuxuryImagePlaceholder";
            ...
            {chunks.map((subarray, colIndex) => (
              ...
              >
                ...
                {subarray.map((project, imageIndex) => (
                  <div className="relative group" key={imageIndex + project.title}>
  ...
  return (
    <div
      style={
        {
          "--background": "#FAFAF8",
          "--color": "rgba(246, 162, 26, 0.2)",
          "--height": "1px",
          "--width": "5px",
          "--fade-stop": "90%",
          "--offset": offset || "200px",
          "--color-dark": "rgba(246, 162, 26, 0.3)",
