          ...
          style={
            {
              ...
              "--gradient":
                ...
                radial-gradient(circle at 60% 60%, hsl(var(--amber-mid)) 10%, hsl(var(--amber-mid) / 0) 20%),
                radial-gradient(circle at 40% 60%, hsl(var(--accent)) 10%, hsl(var(--accent) / 0) 20%),
                repeating-conic-gradient(
                  from 236.84deg at 50% 50%,
                  hsl(var(--primary)) 0%,
                  hsl(var(--accent)) calc(25% / var(--repeating-conic-gradient-times)),
                  hsl(var(--amber-mid)) calc(50% / var(--repeating-conic-gradient-times)),
